...
export const DeleteBankAccountModal = observer(function DeleteBankAccountModal(
  props: DeleteBankAccountModalProps,
) {
  const {
    style,
    actionButtonTitleTx,
  ...
  const handleDeleteOnPress = () => {
    setVisibility(false)
    rootStore.deleteBankAccount({ bank: title, accountNo: bankAccount })
  }
  ...
  return (
    ...
    >
      <View style={[$container, style]}>
        <Text style={$title} tx="deleteBankAccount" />
        <VerticalSeparator />
        <Text style={$informText} tx="deleteBankAccountConfirmation" />
